...
class AdditionDataset(Dataset):
    ...
    def __init__(self, config, split):
        ...
        num = (10**train_ndigit)**2  # total number of possible addition problems with ndigit numbers
        rng = torch.Generator()
...
if __name__ == '__main__':
    ...
    ood_test_dataset = AdditionDataset(config.data, split='ood_test')
    ...
    run_name = f"addition_run{config.run_id}"
